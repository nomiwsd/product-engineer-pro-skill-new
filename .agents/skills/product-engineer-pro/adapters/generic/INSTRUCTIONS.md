...
**Selective Activation:** Do not run heavy multi-file workflow scans unprompted on routine chat messages. Workflows run **only** when invoked via a slash command or explicit request.
